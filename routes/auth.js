...
let {SignUpValidator,LoginValidator,ChangeValidator,forgotValidator,validate} = require('../utils/validator')
...
router.post('/change_password', check_authentication,ChangeValidator,validate,
...
router.post('/forgotpassword',forgotValidator,validate, async function (req, res, next) {
    try {
...
router.post('/resetpassword/:token', forgotValidator, validate, async function (req, res, next) {
    try {
